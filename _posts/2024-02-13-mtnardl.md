...
If you are interested in considering more than two thresholds, use [this program file](/files/private/mtnard_three_thresholds.prg) to estimate a four-thresholds/five-regime MT-NARDL model.

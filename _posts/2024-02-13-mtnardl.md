...
I wrote an EViews program to perform all steps on the go. You can download the program file [here](files/private/mtnard_two_thresholds_program_code.prg). It is, however, presented below:

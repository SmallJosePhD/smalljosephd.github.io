...
I wrote an EViews program to perform all steps on the go. You can download the program file for two thresholds, and three partical sums [here](/files/private/mtnard_two_thresholds_program_code.prg). It is, however, presented below:
...
If you are interested in using more than two thresholds, consider [this program file](/files/private/mtnard_three_thresholds.prg) to estimate a three-thresholds/four-regime MT-NARDL model.
